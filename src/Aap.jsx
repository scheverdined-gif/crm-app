            ...
            <div className="coach-id">
              ...
              <div>
                ...
                <div className="coach-disc">
                  <DisciplineGlyph d={coach.discipline} size={12} /> {disc.label} · {myStudents.length} учеников в {BRANCHES[effectiveBranch].label}
                </div>
              </div>
            </div>
...
/* ============================================================
   ...
   ============================================================ */
function AdminView({ tab, setTab, searchQ, setSearchQ, students, sessions, coaches, managers, manager, onNewSession, onNewStudent, onEditStudent, onDeleteStudent, onEditSession, onDeleteSession, onNewCoach, onEditCoach, onDeleteCoach, onNewManager, onEditManager, onDeleteManager, onLogout }) {
...
function AdminOverview({ students, sessions, coaches, branchFilter }) {
  ...
  const attentionAll = students.filter(s => s.flag || s.attendance < 80);
